...
type ModalProps = {
    selectedEvent: EventKindModel | null,
    visible: boolean,
    setVisible: Function,
    refresh: Function
}

export const EventKindModal = (props: ModalProps) => {
    ...
    }] = eventKindAPI.useCreateMutation();
    const [updateEvent, {
        data: updatedEvent,
        isLoading: isUpdateEventLoading
    }] = eventKindAPI.useUpdateMutation();
    // -----
