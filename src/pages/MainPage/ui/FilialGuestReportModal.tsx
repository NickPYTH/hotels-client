...
export const FilialGuestReportModal = (props: ModalProps) => {
    ...
    const confirmHandler = () => {
        ...
        if (dateRange) {
            ...
            tmpButton.href = `${host}/hotels/api/report/getFilialReport?id=${props.filial.id}&checkouted=${isDefault}&dateStart=${dateStart}&dateFinish=${dateFinish}&fullReport=${false}`
            tmpButton.click();
        } else {
