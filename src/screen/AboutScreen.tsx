...
//@ts-ignore
import MainPage from "../assets/about/MainPage.png";
//@ts-ignore
import FilialPage from "../assets/about/FilialPage.png";
//@ts-ignore
import HotelPage from "../assets/about/HotelPage.png";
//@ts-ignore
import FlatModal from "../assets/about/FlatModal.png";
//@ts-ignore
import TechStatus from "../assets/about/TechStatus.png";
//@ts-ignore
import CheckIn from "../assets/about/CheckIn.png";
//@ts-ignore
import CheckIn1 from "../assets/about/CheckIn1.png";
//@ts-ignore
import CheckIn2 from "../assets/about/CheckIn2.png";
//@ts-ignore
import OrgCheckIn from "../assets/about/OrgCheckIn.png";
//@ts-ignore
import ReasonBilling from "../assets/about/ReasonBillingFields.png";
//@ts-ignore
import TimeField from "../assets/about/TimeField.png";
//@ts-ignore
import FlatModalBusy from "../assets/about/FlatModalBusy.png";
//@ts-ignore
import LockSection from "../assets/about/LockSection.png";
//@ts-ignore
import CheckOut from "../assets/about/CheckOut.png";
//@ts-ignore
import Report1 from "../assets/about/Report1.png";
//@ts-ignore
import Report2 from "../assets/about/Report2.png";
//@ts-ignore
                ...
                <div style={{
                    ...
                    {(selected[0] === '0-0-0' || selected[0] === '0-0') && <div>
                        ...
                        <Flex style={{width: '100%'}} justify={'center'}>
                            <Image width={700} height={450} src={MainPage}/>
                        </Flex>
                        <p>либо непосредственно, объектов проживания закрепленных за пользователем:</p>
                        <Flex style={{width: '100%'}} justify={'center'}>
                            <Image width={600} height={250} src={FilialPage}/>
                        </Flex>
                    </div>}
                    {(selected[0] === '0-1-0') && <div>
                        <Flex style={{width: '100%'}} justify={'center'}>
                            <Image width={800} height={450} src={HotelPage}/>
                        </Flex>
                        ...
                        <Flex style={{width: '100%'}} justify={'center'}>
                            <Image width={800} height={450} src={FlatModal}/>
                        </Flex>
                    ...
                    {(selected[0] === '0-4-0') && <div>
                        ...
                        <p><strong>Ежемесячный отчет по филиалам (реестр проживающих) </strong>
