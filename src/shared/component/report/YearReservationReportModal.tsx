...
export const YearReservationReportModal = (props: ModalProps) => {
    ...
    const confirmHandler = () => {
        ...
        if (date && selectedHotelId) {
            tmpButton.href = `${host}/hotels/api/report/getYearReservationReport?hotelId=${selectedHotelId}&year=${date.format("YYYY")}&format=xlsx`;
            tmpButton.click();
        } else {
    ...
    return (
        <Modal title={"Годовой отчет о бронированиях"}
               open={props.visible}
               onOk={confirmHandler}
        ...
        >
            ...
            <Flex gap={'small'} vertical={true}>
                ...
                <Flex align={"center"}>
                    <div style={{width: 170}}>Выберите год</div>
                    <DatePicker placeholder={'Год'}
                                picker={'year'}
                                format={'YYYY'}
                                value={date}
