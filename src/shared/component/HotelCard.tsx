...
import {HotelGuestReportModal} from "shared/component/HotelGuestReportModal";
                        ...
                        <Tooltip title={"Процент загруженности"}>
                            {hotel.bedsCount === null ?
                                ...
                                <Progress style={{position: 'absolute', top: 5, right: 5}}
                                          size={'small'}
                                          type="circle"
                                          percent={hotel.emptyBedsCount == 0 ? 100 : (hotel.emptyBedsCount && hotel.bedsCount) ? Number((100 - (hotel.emptyBedsCount / hotel.bedsCount) * 100).toFixed(1)) : 0}/>
                            }
                        </Tooltip>
                    </>
                }
